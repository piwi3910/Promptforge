...
export const dellComponents = {
  ...
  navItem: {
    base: "flex items-center gap-2 rounded-md px-1.5 py-1 mx-1 transition-all duration-200 group relative",
    ...
    indicator: "after:absolute after:right-1 after:w-0 after:h-0 after:transition-all after:duration-200 group-hover:after:w-1 group-hover:after:h-1 group-hover:after:bg-white group-hover:after:rounded-full",
  },
